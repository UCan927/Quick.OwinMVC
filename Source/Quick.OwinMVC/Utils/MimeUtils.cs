...
namespace Quick.OwinMVC.Utils
{
    ...
    {
        private readonly static IDictionary<String, String> mimeMap = new Dictionary<String, String>
        {
            #region MIME字典
            ["323"] = "text/h323",
            ["323"] = "text/h323",
        ...
        static MimeUtils()
        {
            mimeMap[DefaultMimeMapKey] = defaultMIME;
        }
        ...
        public static String GetMime(String resourceName)
        {
            ...
            if (mimeMap.TryGetValue(key, out var value)
                && !String.IsNullOrWhiteSpace(value))
                return value;
            if (mimeMap.TryGetValue(DefaultMimeMapKey, out value)
                && !String.IsNullOrWhiteSpace(value))
                return value;
            value = defaultMIME;
            return value;
